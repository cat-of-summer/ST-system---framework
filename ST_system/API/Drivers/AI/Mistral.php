 ...
 */
final class Mistral extends IntegrationDriver {

    protected const DEFAULT_POINT = 'https://api.mistral.ai/v1';
    ...
    protected function __init() {
        ...
        $this->register_methods_map([
            'chat/completions' => [
                ...
                'params' => [
                    'model' => ['mistral-small-latest', fn($v) => is_string($v) && preg_match('/^(mistral|open-mistral|open-mixtral)-[a-z0-9.-]+$/i', $v)],
